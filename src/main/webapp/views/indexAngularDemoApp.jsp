...
<body>
  ...
  <h3>Incomming Key Value : <%=request.getAttribute("demoAngularAppKeyAttribute")%></h3>
  <hr>
...
<script src="/DemoAngularAppResources/runtime.acf0dec4155e77772545.js" defer></script><script src="/DemoAngularAppResources/polyfills.5e0ce2c1a99c8658e3f9.js" defer></script><script src="/DemoAngularAppResources/main.ac79b87ac1efa242be9f.js" defer></script>

<script>
	window.localStorage.setItem('demoAngularAppKey', '<%=request.getAttribute("demoAngularAppKeyAttribute")%>');
</script>
